...
?>
      ...
      <tr>
          <td>
              ...
              <label for="activate_add_caps_for_plugins"><?php esc_html_e('Plugins related: deactivate_plugins', 'user-role-editor'); ?></label>
          </td>
          <td>              
          </td>
      </tr>
      <tr>
          <td>
              ...
              <label for="activate_add_caps_for_languages"><?php esc_html_e('Languages related: install_languages, update_languages', 'user-role-editor'); ?></label>
          </td>
          <td>              
          </td>
      </tr>
