<?php
/*
 * Plugin Name: Wpfcafy Module Loader
...
if ( ! function_exists( 'wpfcafy_moduleloader_autoload_internal' ) ) :
/**
 ...
 */
function wpfcafy_moduleloader_autoload_internal( $class ) {
	// Prefix for all classes that are loaded
	$prefix = 'Wpfcafy_ModuleLoader_';
...
spl_autoload_register( 'wpfcafy_moduleloader_autoload_internal' );

if ( ! function_exists( 'wpfcafy_moduleloader_autoload' ) ) :
/**
 ...
 */
function wpfcafy_moduleloader_autoload( $class, $prefix, $base_dir ) {
	// Prefix for all classes that are loaded
	$prefix = $prefix;
	$length = strlen( $prefix );
