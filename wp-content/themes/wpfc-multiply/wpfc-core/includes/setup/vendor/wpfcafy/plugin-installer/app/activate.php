 ...
 * @since 1.0.0
 */
class Wpfcafy_PluginInstaller_Activate extends Wpfcafy_ModuleLoader_Module {
	...
	public function hook() {
		add_action( 'wp_ajax_wpfcafy_plugininstaller_activate_plugin', array( $this, 'activate_plugin' ) );
	}
	...
	public function activate_plugin() {
		$l10n = wpfcafy_plugininstaller_get_l10n();
